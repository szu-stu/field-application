...
DATABASES = {
    'default': {
        ...
        'NAME': 'doyoubi_db',                      # Or path to database file if using sqlite3.
        'USER': 'dyb',
        'PASSWORD': 'jkui',
...
MEDIA_ROOT = '/var/www/field-application/webroot/uploaded_file/' 
# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://example.com/media/", "http://media.example.com/"
MEDIA_URL = '/uploaded-file/'

# Absolute path to the directory static files should be collected to.
# Don't put anything in this directory yourself; store your static files
# in apps' "static/" subdirectories and in STATICFILES_DIRS.
# Example: "/var/www/example.com/static/"
STATIC_ROOT = '/var/www/field-application/webroot/static/'
...
SECRET_KEY = '+)8zw3wsn6g@(k3@ykxl=0&c1oe0vftz@muo4&xso&pyej65ji'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'field_application.log',
            'formatter': 'verbose',
        },
        'mail_admins': {
            'level': 'ERROR',
