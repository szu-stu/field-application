...
class SignUpForm(UserCreationForm):
    ...
    # User.username will be generated by chinese_name
    ...
    #    trans = PinYin()
    #    trans.load_word()
    #    username = trans.hanzi2pinyin_split(
    #            string=self.cleaned_data['chinese_name'],
    #            split='-')
    #    return super(SignUpForm, self).clean_username(self)

    # force model to save
    def save(self):
        new_user = super(SignUpForm, self).save()
        new_user.username = \
                trans.hanzi2pinyin_split(
                        string=self.cleaned_data['chinese_name'],
                        split='-')
