...
from field_application.student_activity_center.views import ListAppView 
from field_application.student_activity_center.views import ManageView 
from field_application.student_activity_center.views import delete
